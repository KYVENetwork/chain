...
const (
	Msg_Delegate_FullMethodName        = "/kyve.delegation.v1beta1.Msg/Delegate"
	Msg_WithdrawRewards_FullMethodName = "/kyve.delegation.v1beta1.Msg/WithdrawRewards"
	Msg_Undelegate_FullMethodName      = "/kyve.delegation.v1beta1.Msg/Undelegate"
	Msg_Redelegate_FullMethodName      = "/kyve.delegation.v1beta1.Msg/Redelegate"
	Msg_UpdateParams_FullMethodName    = "/kyve.delegation.v1beta1.Msg/UpdateParams"
)
...
func (c *msgClient) WithdrawRewards(ctx context.Context, in *MsgWithdrawRewards, opts ...grpc.CallOption) (*MsgWithdrawRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_WithdrawRewards_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
