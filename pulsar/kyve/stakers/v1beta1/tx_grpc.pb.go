...
const (
	Msg_CreateStaker_FullMethodName     = "/kyve.stakers.v1beta1.Msg/CreateStaker"
	Msg_UpdateMetadata_FullMethodName   = "/kyve.stakers.v1beta1.Msg/UpdateMetadata"
	Msg_UpdateCommission_FullMethodName = "/kyve.stakers.v1beta1.Msg/UpdateCommission"
	Msg_JoinPool_FullMethodName         = "/kyve.stakers.v1beta1.Msg/JoinPool"
	Msg_LeavePool_FullMethodName        = "/kyve.stakers.v1beta1.Msg/LeavePool"
	Msg_UpdateParams_FullMethodName     = "/kyve.stakers.v1beta1.Msg/UpdateParams"
)
...
func (c *msgClient) UpdateCommission(ctx context.Context, in *MsgUpdateCommission, opts ...grpc.CallOption) (*MsgUpdateCommissionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UpdateCommission_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) LeavePool(ctx context.Context, in *MsgLeavePool, opts ...grpc.CallOption) (*MsgLeavePoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_LeavePool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateCommission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_UpdateCommission_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_LeavePool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_LeavePool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
