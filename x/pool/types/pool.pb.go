...
const (
	...
	POOL_STATUS_END_KEY_REACHED PoolStatus = 7
)
...
type Pool struct {
	...
	InflationShareWeight cosmossdk_io_math.LegacyDec `protobuf:"bytes,12,opt,name=inflation_share_weight,json=inflationShareWeight,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"inflation_share_weight"`
	// min_delegation ...
...
var fileDescriptor_40c1730f47ff2ef8 = []byte{
	...
	,
}
...
func (m *Pool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EndKey) > 0 {
		...
		i = encodeVarintPool(dAtA, i, uint64(len(m.EndKey)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa2
