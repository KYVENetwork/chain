...
* TODO: Produce a valid bundle with only one funder and multiple coins
* TODO: Produce a valid bundle with multiple funders and multiple coins
* TODO: Produce a valid bundle although the only funder can not pay for the full bundle reward
