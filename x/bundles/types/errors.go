...
var (
	...
	ErrPoolMinDelegationNotReached   = errors.Register(ModuleName, 1200, "pool min delegation not reached")
	...
	ErrGlobalMinDelegationNotReached = errors.Register(ModuleName, 1207, "global min delegation not reached")
)
