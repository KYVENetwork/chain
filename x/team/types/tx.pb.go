...
type MsgClawback struct {
	...
	Clawback uint64 `protobuf:"varint,3,opt,name=clawback,proto3" json:"clawback"`
}
...
type MsgCreateTeamVestingAccount struct {
	...
	TotalAllocation uint64 `protobuf:"varint,2,opt,name=total_allocation,json=totalAllocation,proto3" json:"total_allocation"`
	// commencement is the unix timestamp of the member's official start date.
	Commencement uint64 `protobuf:"varint,3,opt,name=commencement,proto3" json:"commencement"`
}
...
var fileDescriptor_1ad042ec4c659ded = []byte{
	...
	,
}
