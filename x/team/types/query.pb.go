...
type QueryTeamInfoResponse struct {
	...
	TotalTeamAllocation uint64 `protobuf:"varint,2,opt,name=total_team_allocation,json=totalTeamAllocation,proto3" json:"total_team_allocation,omitempty"`
	// issued_team_allocation is the amount in $KYVE tied to team vesting accounts and which are not available anymore
	IssuedTeamAllocation uint64 `protobuf:"varint,3,opt,name=issued_team_allocation,json=issuedTeamAllocation,proto3" json:"issued_team_allocation,omitempty"`
	...
	AvailableTeamAllocation uint64 `protobuf:"varint,4,opt,name=available_team_allocation,json=availableTeamAllocation,proto3" json:"available_team_allocation,omitempty"`
	...
	TotalAuthorityRewards uint64 `protobuf:"varint,5,opt,name=total_authority_rewards,json=totalAuthorityRewards,proto3" json:"total_authority_rewards,omitempty"`
	// claimed_authority_rewards is the amount in $KYVE of how much the authority already claimed
	ClaimedAuthorityRewards uint64 `protobuf:"varint,6,opt,name=claimed_authority_rewards,json=claimedAuthorityRewards,proto3" json:"claimed_authority_rewards,omitempty"`
	// available_authority_rewards is the amount in $KYVE of how much rewards the authority can claim right now
	AvailableAuthorityRewards uint64 `protobuf:"varint,7,opt,name=available_authority_rewards,json=availableAuthorityRewards,proto3" json:"available_authority_rewards,omitempty"`
	// total_account_rewards is the amount in $KYVE all team vesting accounts have ever received
	TotalAccountRewards uint64 `protobuf:"varint,8,opt,name=total_account_rewards,json=totalAccountRewards,proto3" json:"total_account_rewards,omitempty"`
	// claimed_account_rewards is the amount in $KYVE all team vesting accounts have ever claimed
	ClaimedAccountRewards uint64 `protobuf:"varint,9,opt,name=claimed_account_rewards,json=claimedAccountRewards,proto3" json:"claimed_account_rewards,omitempty"`
	// available_account_rewards is the total amount of $KYVE all team vesting accounts can currently claim
	AvailableAccountRewards uint64 `protobuf:"varint,10,opt,name=available_account_rewards,json=availableAccountRewards,proto3" json:"available_account_rewards,omitempty"`
	// required_module_balance is the balance the team module should have. If this is less than the module balance
	// something went wrong
	RequiredModuleBalance uint64 `protobuf:"varint,11,opt,name=required_module_balance,json=requiredModuleBalance,proto3" json:"required_module_balance,omitempty"`
	// team_module_balance is the team module balance in $KYVE
	TeamModuleBalance uint64 `protobuf:"varint,12,opt,name=team_module_balance,json=teamModuleBalance,proto3" json:"team_module_balance,omitempty"`
}
...
func (m *QueryTeamInfoResponse) GetAuthority() string {
	if m != nil {
		return m.Authority
	}
	return ""
...
var fileDescriptor_6dd564523865e528 = []byte{
	...
	,
}
