...
// https://github.com/cosmos/gaia/blob/b3583a755ad2947582f8e9c969806b187668ea23/x/liquid/keeper/tokenize_share_record_test.go
...
func (suite *KeeperTestSuite) TestGetLastTokenizeShareRecordId() {
	ctx, keeper := suite.ctx, suite.lsmKeeper
