...
// source: kyve/oracle/sender/v1/query.proto
...
import (
	context "context"
	fmt "fmt"
	types "github.com/KYVENetwork/chain/x/oracle/host/types"
...
// QueryRequest is request type for the Query/Request RPC method.
...
func (*QueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5b703a5321b7bee, []int{0}
}
...
func (m *QueryRequest) GetSequence() uint64 {
	if m != nil {
		return m.Sequence
	}
	return 0
...
type QueryRequestResponse struct {
	// request ...
	Request *types.OracleQuery `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
}
...
func (*QueryRequestResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5b703a5321b7bee, []int{1}
}
...
func (m *QueryRequestResponse) GetRequest() *types.OracleQuery {
	if m != nil {
		return m.Request
	}
	return nil
...
// QueryResponse is request type for the Query/Response RPC method.
...
func (*QueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5b703a5321b7bee, []int{2}
}
...
func (m *QueryResponse) GetSequence() uint64 {
	if m != nil {
		return m.Sequence
	}
	return 0
...
type QueryResponseResponse struct {
	// response ...
	Response *types.OracleAcknowledgement `protobuf:"bytes,1,opt,name=response,proto3" json:"response,omitempty"`
}
...
func (*QueryResponseResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5b703a5321b7bee, []int{3}
}
...
func (m *QueryResponseResponse) GetResponse() *types.OracleAcknowledgement {
	if m != nil {
		return m.Response
	}
	return nil
...
func init() {
	proto.RegisterType((*QueryRequest)(nil), "kyve.oracle.sender.v1.QueryRequest")
	proto.RegisterType((*QueryRequestResponse)(nil), "kyve.oracle.sender.v1.QueryRequestResponse")
	proto.RegisterType((*QueryResponse)(nil), "kyve.oracle.sender.v1.QueryResponse")
	proto.RegisterType((*QueryResponseResponse)(nil), "kyve.oracle.sender.v1.QueryResponseResponse")
}

func init() { proto.RegisterFile("kyve/oracle/sender/v1/query.proto", fileDescriptor_b5b703a5321b7bee) }

var fileDescriptor_b5b703a5321b7bee = []byte{
	// 389 bytes of a gzipped FileDescriptorProto
	,
}
...
type QueryClient interface {
	...
	// Response ...
	Response(ctx context.Context, in *QueryResponse, opts ...grpc.CallOption) (*QueryResponseResponse, error)
}
...
func (c *queryClient) Request(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*QueryRequestResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kyve.oracle.sender.v1.Query/Request", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Response(ctx context.Context, in *QueryResponse, opts ...grpc.CallOption) (*QueryResponseResponse, error) {
	out := new(QueryResponseResponse)
	err := c.cc.Invoke(ctx, "/kyve.oracle.sender.v1.Query/Response", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// Response ...
	Response(context.Context, *QueryResponse) (*QueryResponseResponse, error)
}
...
func (*UnimplementedQueryServer) Response(ctx context.Context, req *QueryResponse) (*QueryResponseResponse, error) {
...
func _Query_Request_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kyve.oracle.sender.v1.Query/Request",
	}
...
func _Query_Response_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kyve.oracle.sender.v1.Query/Response",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).Response(ctx, req.(*QueryResponse))
	}
	return interceptor(ctx, in, info, handler)
}

var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "kyve.oracle.sender.v1.Query",
	...
	Metadata: "kyve/oracle/sender/v1/query.proto",
}
...
func (m *QueryResponseResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Response == nil {
				m.Response = &types.OracleAcknowledgement{}
			}
