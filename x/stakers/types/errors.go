...
var (
	...
	PoolAddressAlreadyUsed     = errors.Register(ModuleName, 1108, "valaddress already used")
	...
	ErrPoolAddressSameAsStaker = errors.Register(ModuleName, 1111, "Valaddress has same address as Valaddress")
	...
	ErrNoPoolAccount              = errors.Register(ModuleName, 1120, "sender has no valaccount")
)
