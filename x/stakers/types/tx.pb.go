...
type MsgCreateStaker struct {
	...
	Commission github_com_cosmos_cosmos_sdk_tyoes.DecProto `protobuf:"bytes,3,opt,name=commission,proto3,customtype=github.com/cosmos/cosmos-sdk/tyoes.DecProto" json:"commission"`
}
...
type MsgUpdateCommission struct {
	...
	Creator string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	// commission ...
	Commission github_com_cosmos_cosmos_sdk_tyoes.DecProto `protobuf:"bytes,2,opt,name=commission,proto3,customtype=github.com/cosmos/cosmos-sdk/tyoes.DecProto" json:"commission"`
}
...
var fileDescriptor_f52b730e69b9fb06 = []byte{
	...
	,
}
