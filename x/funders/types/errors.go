...
var (
	...
	ErrCoinNotWhitelisted                = errors.Register(ModuleName, 1108, "coin in amount not in whitelist")
	ErrAmountPerBundleCoinNotWhitelisted = errors.Register(ModuleName, 1109, "coin in amount per bundle not in whitelist")
	ErrInvalidAmountPerBundleCoin        = errors.Register(ModuleName, 1110, "coin in amount per bundle is not in funding amounts")
)
